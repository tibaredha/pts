...
{ 
	function color($x) 
{	
	if($x>=0 and $x<=1){$this->SetDrawColor(255,0,0);$this->SetFillColor(255,64,64);}
	if($x>1 and $x<=10){$this->SetDrawColor(255,0,0);$this->SetFillColor(238,59,59);}
	if($x>10 and $x<=100){$this->SetDrawColor(255,0,0);$this->SetFillColor(255,127,36);}
	if($x>100 and $x<=1000){$this->SetDrawColor(255,0,0);$this->SetFillColor(255,185,15);}
	if($x>1000 and $x<=1000000){$this->SetDrawColor(255,0,0);$this->SetFillColor(255,20,147);}	
}
