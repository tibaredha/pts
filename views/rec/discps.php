...
$data = array(
"titre"     => 'Distribution CPS iso groupe iso rhesus ', 
"btn"       => 'dis', 
"id"        => $this->user[0]['id'],
"butun"     => 'Receveur: Distribution CPS ', 
"photos"    => 'cgrplaq.jpg',
"action"    => 'rec/DISOK',
"DINS"      => date('Y-m-d'),
"HINS"      => date("H:i"),
...
"DGC"       => array("Thrombopenie"),
"PSL"       => "CPS" ,
"valuemed"  => "1" ,
"selectedmed" => "medecin" ,//prevoir  cherche la derniere distribution et affiche le nom du medecin  
"x"         => "30",
"y"         => "390"
);
