...
<form method="post" action="<?php echo URL;?>don/COMP1/"> 
	<label>Date Compagne</label><input type="text" name="DATEDON" value="<?php echo date('Y-m-d') ?>" /><br/>
	<label>Type Compagne</label><?php combov(260,310,'STR',array("FIXE", "MOBILE"));?><br />
	<label>Adresse Compagne</label> <?php WILAYA(260,540,'WILAYAR','countryr','gpts2012','wil');?>&nbsp;<?php COMMUNE(670,540,'COMMUNER','COMMUNER');?><input type="text" name="ADRESSE" value="Ain-oussera" required /><br />
...
<?php
echo '<a href="'.URL.'pdf/impcomp.php">Imprimer Compagnes</a>'; echo '&nbsp;';	
?>
</th> 
...
<th style="width:80px;">Date Compagne</th> 
...
{	
        ...
        ?>
			...
			<td align="center"><a title="fiche compagne<?php echo trim($value['id']).', '.trim($value['DATEDON'])?>'s Record"" href="<?php echo URL.'pdf/FCOMP.php?DATEDON='.$value['DATEDON'].'&id='.$value['id'];?>"><img src="<?php echo URL.'public/images/icons/print.PNG';?>" width='16' height='16' border='0' alt=''/></a></td>
