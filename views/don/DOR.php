...
echo '</br>';
echo '</br>';
view::graphebi(30,380,'Etat Des Dons OCCASIONNEL/REGULIER  ARRET AU  :','4','don','DATEDON','IND',date("Y"),'IND',"TDNR ='OCCASIONNEL'","TDNR ='REGULIER'","OCCASIONNEL","REGULIER");
//view::graphemois(30,380,'Dons Par Mois Arret Au  : ','4','don','DATEDON','IND',date("Y"),'IND',"STR IS NOT NULL") ;
view::BOUTONGRAPHE(30,645);
$x=1120;
$y=380;
