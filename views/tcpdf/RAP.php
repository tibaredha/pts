...
$sql = "select * from $tbl where MODESORTI=$y";
...
$pdf->SetXY(85,$h);$pdf->cell(46,10,numbr1('cons'),1,0,'C',0);
$pdf->SetXY(131,$h);$pdf->cell(70,10,"RAS",1,0,'C',0);
$h=100;
$pdf->SetXY(05,$h);$pdf->cell(80,10,"Hospitalisés",1,0,'L',0);
$pdf->SetXY(85,$h);$pdf->cell(46,10,numbr('hosp',0),1,0,'C',0);
$pdf->SetXY(131,$h);$pdf->cell(70,10,"RAS",1,0,'C',0);
$h=110;
...
$pdf->SetXY(85,$h);$pdf->cell(46,10,numbr1('cons')-numbr('hosp',0),1,0,'C',0);
$pdf->SetXY(131,$h);$pdf->cell(70,10,"RAS",1,0,'C',0);
$h=140;
$pdf->SetXY(05,$h);$pdf->cell(80,10,"Evacués Motifs Lieu D'évacuation ",1,0,'L',0);
$pdf->SetXY(85,$h);$pdf->cell(46,10,numbr('hosp',3),1,0,'C',0);
...
$query = "SELECT * FROM hosp where MODESORTI=0  ";//where SORTI =''where DATEDUDECE >= '2014-01-01'
