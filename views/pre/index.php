...
<th style="width:50px;">PREPARATION</th>
...
{	
        ...
        ?>
			...
			<td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'pre/edit/'.$value['id'];?>'" title="prepare <?php echo $value['IDP'].', '.$value['IDP']?>'s Record" <?php //echo ($allow_donate==FALSE)?'disabled':'';?> >&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/b_engine.png';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>
		...
		if ($total_count <= 0 )
		{
		echo '<tr><td align="center" colspan="10" ><span> No record found for preparation </span></td> </tr>';
