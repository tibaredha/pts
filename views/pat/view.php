...
View::h('2',25,290,'Patient :  [ '.$this->user[0]['NOM']."_".$this->user[0]['PRENOM']." ]");
?>
<br /><br />
<hr /><br />
<div class="tabbed_area">  
		...
		<th style="width:30px;">Hosp</th>
		<th style="width:30px;">FS</th>
		<th style="width:10px;">SAS</th>
		<th style="width:30px;">DATE/E</th>
		<th style="width:50px;">SERVICE</th>
		<th style="width:30px;">NLIT</th>
		<th style="width:50px;">DGC</th>
		<th style="width:50px;">SORTI</th>
		<th style="width:50px;">DATE/S</th>
		<th style="width:50px;">MODE</th>
		<th style="width:25px;">RSDS/RCDS</th>
		<th style="width:25px;">F/N</th>
		<th style="width:25px;">Evacuation</th>
		<th style="width:25px;">Deces</th>
		<th style="width:25px;">Update </th>
		...
		{		
				foreach($this->userListview1 as $key1 => $value1){ ?>
						...
						<td align="center" class="bg-gray" "><a title="Demande Hospitalisation" href="<?php echo URL.'tcpdf/hospobs.php?id='.$value1['id'].'&IDDNR='.$this->user[0]['id'];?>"><img src='<?php echo URL.'public/images/icons/lab1.jpg';?>' width='16' height='16' border='0' alt=''/></a></td>       
						<td align="center" class="bg-gray" "><a title="fiche de surveillance" href="<?php echo URL.'tcpdf/sur.php?id='.$value1['id'].'&IDDNR='.$this->user[0]['id'];?>"><img src='<?php echo URL.'public/images/icons/lab1.jpg';?>' width='16' height='16' border='0' alt=''/></a></td>       
						<td align="center" class="bg-gray" "><a title="Envenimation Scorpionique" href="<?php echo URL.'pat/sas/'.$this->user[0]['id'].'/'.$value1['id'];?>"><img src='<?php echo URL.'public/images/icons/lab1.jpg';?>' width='16' height='16' border='0' alt=''/></a></td>       
						<td align="center"><?php echo $value1['DATEDON'];?></td>
						<td align="left"><?php echo nbrtostring('service','ids',$value1['SERVICE'],'servicefr') ;?></td>
						<td align="center"><?php echo  nbrtostring('lit','idlit',$value1['NLIT'],'nlit');?></td>
						<td align="center"><?php echo $value1['DGC'];?></td>
						<td align="center"><a title="SORTIE" href="<?php echo URL.'pat/editsortihosp/'.$value1['id'];?>"><img src='<?php echo URL.'public/images/icons/s_loggoff.png';?>' width='16' height='16' border='0' alt=''/></a></td>
						...
						<td align="center"><a title="Resume Standard De Sortie "href="<?php echo URL.'pdf/RSS.php?id='.$value1['id'].'&IDDNR='.$this->user[0]['id'].'&MODESORTI='.$value1['MODESORTI'];?>"><img src='<?php echo URL.'public/images/icons/lab1.jpg';?>' width='16' height='16' border='0' alt=''/></a></td>       
				...
				{
				echo '<tr><td align="center" colspan="16" ><span> No record found for donor </span></td> </tr>';
				echo '<tr bgcolor="#00CED1"  ><td align="left"   colspan="16" ><span>' .$total_count1.'/'.$total_count1.' Record(s) found.</span></td></tr>';					
				}
				else
				{		
				//echo '<tr bgcolor=""  ><td align="center" colspan="16" >'. barre_navigation ($total_count,$this->userListviewl,$this->userListviewo,$this->userListviewq,$this->userListviewp,$this->userListviewb).'</td></tr>';	
			    echo '<tr bgcolor="#00CED1"  ><td align="left"   colspan="16" ><span>' .$total_count1.' Record(s) found.</span></td></tr>';					
				}		
		}
		else 
		{
