...
View::h('2',25,290,'Patient : Vaccination [ '.$this->user[0]['NOM']."_".$this->user[0]['PRENOM']." ]");
View::sautligne(2);
View::hr();
...
<div class="tabbed_area">  
        <ul class="tabs">  
			...
			<li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">anti socorpionique</a></li> 	
        </ul>
		<div id="content_1" class="content">
		<h2>Calendrie Vaccinal
		<A HREF="<?php echo URL;?>views/doc/vacci/vaccination.pdf"> REF:JO n°75 du 28/12/2014</A></h2>
		<br/><br/>
