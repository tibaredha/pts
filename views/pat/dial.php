...
View::h('2',25,290,'Patient : Dialyse [ '.$this->user[0]['NOM']."_".$this->user[0]['PRENOM']." ]");
View::sautligne(2);
View::hr();
View::f0(URL.'pat/BILANOK/','post');
// View::url(1100,300,URL.'pdf/LABODNR.php?uc='.$this->user[0]['id'],'Demande Bilan',3);
...
// View::label(225,370,'GR'); View::txtjs1(280,360,'GR',29,'00','bilan()'); //View::date(280,360,'GR',0,'0');
// View::label(225,370+30,'HT'); View::txtjs1(280,360+30,'HT',29,'00','bilan()');// View::date(280,360+30,'HT',0,'0');
// View::label(225,370+60,'HB'); View::txtjs1(280,360+60,'HB',29,'00','bilan()');// View::date(280,360+60,'HB',0,'0');
...
// View::label(25,370+150+60,'TGL');     View::txtjs1(80,360+150+60,'TGL',29,'00','cholesterol()');//View::date(0,'0');
// View::label(25,370+150+90,'CT');      View::txtjs1(80,360+150+90,'CT',29,'00','cholesterol()');//View::date(0,'0');
// View::label(25,370+150+120,'HDL');    View::txtjs1(80,360+150+120,'HDL',29,'00','cholesterol()');//View::date(0,'0');
...
// View::label(225,370+150+120,'ASPECT');$Jour=array("clair"=>0,"opalescent"=>1);View::combovc(280,360+150+120,'ASPECT',$Jour); 
...
// View::label(425,370+150+150,'Poids');   View::date(480,360+150+150,'Poids',0,'0');
...
// View::label(1100,360+5,'LIEUX');        View::combov(1200,350+5,'LIEUX',array("FIXE","MOBILE")); 
...
<div class="tabbed_area">  
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">seance</a></li>  
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Hematologie</a></li> 
			<li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">Biochimie</a></li> 	
        </ul>
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<td align="center"><a title="editer" href="<?php echo URL.'pat/editbilan/'.$value['idbio'];?>"><img src='<?php echo URL.'public/images/icons/edit.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>
						<td align="center"><a class="delete" title="supprimer" href="<?php echo URL.'pat/deletebilan/'.$value['idbio'].'/'.$value['ID'];?>"><img src='<?php echo URL.'public/images/icons/delete.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>
						</tr>
				<?php 
				}
		...
		<h2>Hematologie</h2><A HREF="<?php echo URL;?>views/doc/trans/hemmograme.pdf">hemmograme.pdf</A>
		<br/><br/>
		<table  width='90%' border='1' cellpadding='5' cellspacing='1' align='center'>
		<tr>
		<th colspan="21">Imprime List FNS</th> 
