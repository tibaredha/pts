...
echo "<th style=\"width:150px;\">IDSERVICE</th>" ;
echo "<th style=\"width:50px;\">NLIT</th>" ;
...
echo "</tr>" ;		
		...
		?>
			...
			<td align="left" >  <?php echo view::nbrtostring('service','ids',$value['idservice'],'servicefr');?></td>
			<td align="center" >  <?php echo $value['nlit'];?></td>
