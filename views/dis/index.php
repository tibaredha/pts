...
<?php	
        ...
        ?>
						...
						<td align="center"><?php echo $value['SERVICE']; //echo nbrtostring('ser','id',$value['SERVICE'],'service');?></td>
...
echo '</br>';
echo '</br>';
view::graphemoisdx(30,380,'Etat Des Etat Des Distributions CGR  ARRET AU  :','CGR','1');
