...
echo "</tr>" ;		
        ...
        echo "<tr bgcolor=\"".$bgcolor_donate."\"  onmouseover=\"this.style.backgroundColor='#9FF781';\"   onmouseout=\"this.style.backgroundColor='".$bgcolor_donate."';\"  >" ;
		      echo "<td align=\"center\"><a title=\"Modifier Photos\" href=\"".URL."dnr/upl/".$value['id']."\" ><img  src=\"".URL."public/webcam/dnr/".$fichier."\"  width='25' height='25' border='1' alt='photos'></td> " ;
...
echo '</br>';
$y=395;
view::graphemoisdnr(30,$y,'Donneurs Par Mois Arret Au  : ','4','dnr','DINS','SRS',date("Y"),'4',"SRS IS NOT NULL");	
view::BOUTONGRAPHE1(30,660);
$x=1120;
